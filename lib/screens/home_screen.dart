...
class _KekeContactsListScreenState extends State<KekeContactsListScreen> {
  ...
  Widget build(BuildContext context) {
    // This widget now only returns the ListView.builder for the contacts.
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: rider.isBooked ? Colors.grey[600] : Colors.yellow, // Grey if booked, green if available
